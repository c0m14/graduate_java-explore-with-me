...
class AdminEventControllerTest {
    ...
    @Captor
    private ArgumentCaptor<UpdateEventAdminRequest> updateRequestArgumentCaptor;
    ...
    void updateEvent_whenInvoked_thenStatusIsOkAndParamsPassedToService() {
        Long eventId = 0L;
        UpdateEventAdminRequest updateRequest = TestDataProvider.getValidUpdateEventAdminRequest();
